 ...
 * 转换类
 */
class Sky private constructor(val info: String, @DrawableRes val icon: Int, @DrawableRes val bg: Int) {
    companion object {
        private val skyMap = mapOf(
            ...
            "PARTLY_SNOW" to Sky("中雪", R.drawable.ic_moderate_snow, R.drawable.bg_snow),
        ...
        fun getSky(skycon: String) = skyMap[skycon] ?: skyMap["CLEAR_DAY"]!!
    }
}
